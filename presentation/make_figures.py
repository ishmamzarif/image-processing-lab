...
save("grid_sharpen", u8(sharpen.sharpen_image(cat_s_clean, 15.0, 1.5) * 255.0))
save("grid_edges", u8(edges.detect_edges(cat_s, 15.0) * 255.0))
...
sharp, t_sh = timed(sharpen.sharpen_image, fl_clean, 15.0, 1.5)
sharp = u8(sharp * 255.0)
ed, t_ed = timed(edges.detect_edges, fl, 15.0)
