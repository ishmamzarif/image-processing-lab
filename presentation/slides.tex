...
\makebox[\linewidth][l]{\hspace{2.5mm}%
  \tikz\node[draw=black!15, inner sep=0pt]{\includegraphics[width=\linewidth]{app_denoise}};}
\end{columns}
\end{frame}
...
\vspace{1.2em}
\centering
\pic{2.1cm}{blur_input}{input}\hspace{3pt}
\pic{2.1cm}{resize_blocky}{$\times0.2$, then $\times5$}\hspace{16pt}
\pic{2.1cm}{zone}{zone plate}\hspace{3pt}
\pic{2.1cm}{zone_nearest}{$\downarrow 4$, nearest (ours)}\hspace{3pt}
\pic{2.1cm}{zone_lowpass}{$\downarrow 4$, low-pass first}
...
\begin{thebibliography}{9}
  \bibitem{cooley} J.~W. Cooley, J.~W. Tukey. An algorithm for the machine calculation of
    complex Fourier series. \emph{Math. Comp.} 19(90):297--301, 1965.
  \bibitem{bluestein} L.~I. Bluestein. A linear filtering approach to the computation of the
    discrete Fourier transform. \emph{IEEE Trans. Audio Electroacoust.} 18(4):451--455, 1970.
  \bibitem{drpe} P.~Refregier, B.~Javidi. Optical image encryption based on input plane and
    Fourier plane random encoding. \emph{Optics Letters} 20(7):767--769, 1995.
  \bibitem{jpeg} G.~K. Wallace. The JPEG still picture compression standard.
    \emph{IEEE Trans. Consumer Electron.} 38(1):xviii--xxxiv, 1992.
  \bibitem{oppenheim} A.~V. Oppenheim, A.~S. Willsky, S.~H. Nawab.
    \emph{Signals and Systems}, 2nd ed. Prentice Hall, 1997.
