...
\vspace{1.2em}
\centering
\pic{2.8cm}{cat_input}{clean}\hspace{6pt}
\pic{2.8cm}{denoise_noisy}{noisy \enspace 24.5 dB}\hspace{6pt}
% the app's own 3D view (spectrum-3d.js, Noisy), exported from its canvas
\pic{2.8cm}{denoise_spectrum_3d}{spectrum in 3D, 6 spikes notched}\hspace{6pt}
\pic{2.8cm}{denoise_clean}{denoised \enspace \alert{37.8 dB}}
